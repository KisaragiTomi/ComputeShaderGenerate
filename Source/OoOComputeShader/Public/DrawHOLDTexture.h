...
struct OOOCOMPUTESHADER_API FDRawHLODTextureCSParameters
{
	int X;
	int Y;
	int Z;
...
//
class OOOCOMPUTESHADER_API FDrawHOLDTextureCSInterface
{
public:
...
class OOOCOMPUTESHADER_API UDrawHOLDTexture : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
